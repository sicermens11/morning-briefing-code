...
# ⚠️⚠️ **「92px 고정」이 아니라 「90~95px」이다** (2026-09-14 지시).
#    2026-09-14 에 여덟 장을 크롬으로 실측하니 **90 · 91 · 91 · 91 · 94 ·
#    95 · 95 · 90** 이었다 — **92 에 정확히 선 장은 하나도 없다.**
#    글줄 수와 글꼴 줄높이에 따라 몇 px 씩 갈리는 게 정상이고,
#    92 고정으로 적으면 **정상 카드 여덟 장이 전부 「어긋남」으로 잡힌다.**
#    (사용자: 「92 고정은 내가 잘못 적은 값이다」)
#    ⇒ 하한 90 은 그대로 두고, **명세 표기만** 범위로 적는다.
