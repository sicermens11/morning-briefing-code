# ==============================================================
#  night3_queue.ps1 — **고친 뒤 앞뒤 분할 붙인 줄** (2026-09-15 새벽 신설)
#
...
$log = "run-logs\night3_$(Get-Date -f yyyyMMdd_HHmm).log"
...
적기 "===== 앞뒤 분할 붙인 줄 시작 (이름 겹침 · --최근N년 · 재기 메모리 고친 뒤) ====="
적기 "[0] 앞 판(죽일 수 없던 U판)이 끝나길 기다린다"

판돌리기 "R3_새재료_전체기간_앞뒤" "재료 전체 10.4년 + **앞뒤 분할**" `
         "scripts\combo4_lab.py" @{} $null 18000
판돌리기 "S3_새재료_최근1년_앞뒤" "+ 뉴스 · 진짜 1년 + **앞뒤 분할**" `
