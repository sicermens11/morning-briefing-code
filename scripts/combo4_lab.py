...
def main():
    ...
    _뉴단독 = [라 for 라 in sorted(조건) if "뉴스" in 라]
    _뉴쌍 = [(라, 짝) for _v, 라, _n, _낸, 짝 in 쌍[:60]
             if "뉴스" in 짝[0] or "뉴스" in 짝[1]][:15]
